...
function gotot(params) {
  if (params === 'add') {
    if (window.location.pathname != '/announcement.html') {
      window.location.pathname = './announcement.html';
    }
  } else if (params === 'implement') {
    window.location.pathname = './implement.html';
  }
  else if (params === 'search') {
    window.location.pathname = './search.html';
  }
  else if (params === 'search_details') {
    window.location.pathname = './search_details.html';
  }
}
